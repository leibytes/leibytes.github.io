---
title: '【博客园使用技巧】博客园主题皮肤自定义设置'
date: 2019-02-26 09:14:00
categories:
  - 博客园使用技巧
------

# 1.以Moonlightlnk作为基础皮肤的主题设置

通过自定义页面css，并且申请启用js权限。一共包括四部分的代码：页面定制CSS代码、博客侧边栏公告代码（支持HTML和JS代码）、页首Html代码、页脚Html代码。

## 1.1.页面定制CSS代码

![](/images/博客园使用技巧/博客园主题皮肤自定义设置_001.gif)![](/images/博客园使用技巧/博客园主题皮肤自定义设置_002.gif)
...
<script type="text/javascript" src="https://files.cnblogs.com/files/leiblog/clock.js"></script>
...
a.ready(function() {
    ...
    b.append(i);
    //指定让那几级标题作为目录-------------这一点非常重要，因为每个人指定的范围都不一样，所以这是要修改的地方
    //o = s.find(':header');
    ...
    o.each(function(t) {
        ...
        if(v.localName === 'h1') {
            ...
            if(q) {
                //if(text.length > 12) text = text.substr(0, 12) + "...";
                j += '<li class="h1Offset"><a href="#' + u.attr('id') + '" title="' + title + '">' + text + '</a></li>';
            }
        } else if(v.localName === 'h3') {
            n++;
            if(r) {
                j += '<li class="h2Offset"><a href="#' + u.attr('id') + '" title="' + title + '">' + u.text() + '</a></li>';
            }
        }
    });
    $('#' + f + '>ul').html(j);
...
<script>
    window.tctipConfig = {
      ...
      buttonTip: "dashang",
      list:{
        alipay: {qrimg: "https://files.cnblogs.com/files/leiblog/zl_zfb_receiveMoney.bmp"},
        weixin:{qrimg: "https://files.cnblogs.com/files/leiblog/zl_wx_receiveMoney.bmp"},
      }
    };
</script>
<script src="https://files.cnblogs.com/files/leiblog/tctip.min.js"></script>
<link type="text/css" rel="stylesheet" href="https://files.cnblogs.com/files/leiblog/myRewards.css">
<link  type="text/css" rel="stylesheet" href="https://files.cnblogs.com/files/leiblog/feedback.css">
<link  type="text/css" rel="stylesheet" href="https://files.cnblogs.com/files/leiblog/maodian.css">
```
...
<script src="https://files.cnblogs.com/files/leiblog/jquery-migrate-1.2.1.js"></script>
<div id="scrollTop" style="display:none;">
      <div class="level-2"></div>
      <div class="level-3"></div>
</div>
<script src="http://files.cnblogs.com/files/leiblog/scroll2top.js"></script>
<script type="text/javascript">
    UI.global_search();
    var uvOptions = {};
    // !important
...
<script src="https://files.cnblogs.com/files/leiblog/bootstrap.min.js"></script>
```

View Code

各部分代码的具体含义可参照博文：[欠的债，这一次都还给你们](https://www.cnblogs.com/hafiz/p/9276689.html "一套简约漂亮的响应式博客园主题皮肤分享给你们")

# 2.其它主题

CodingLife主题的设置：[CodingLife主题设置](https://www.cnblogs.com/trlanfeng/p/5343935.html "CodingLife主题设置")
